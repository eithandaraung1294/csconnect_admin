...
export default function NavBarMenuPage() {
    ...
    //* api url
    const getAllUserUrl = '/admin/navbar-menus/all';
    const deletUserUrl = '/admin/navbar-menus/delete';
    ...
    return (
        ...
        <Container>
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                ...
                <Link to="/dashboard/navbar-menus/create" component={RouterLink} state={{ from: location}} replace>
                ...
                <Scrollbar>
                    ...
                    <Table>
                        ...
                        {filteredNbMenus?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)?.map((row) => {
                            const { id, e_title, m_title, priority, published } = row;
                            return (
        ...
        >
            <Link to={`/dashboard/navbar-menus/edit/${openId}`} component={RouterLink} sx={{ display: 'contents' }}>
            <MenuItem>
