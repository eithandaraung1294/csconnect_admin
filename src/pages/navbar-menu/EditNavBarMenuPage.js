...
export default function EditNavBarMenuPage() {
    const location = useLocation();
    const [nbMenu, setNbMenu] = useState();
    const [error, setError] = useState();
    const axiosPrivate = useAxiosPrivate();
    const from = location.state?.from.pathname || "/dashboard/navbar-menus";
    const getUserUrl = "/admin/navbar-menus/";
