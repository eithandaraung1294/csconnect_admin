...
const TABLE_HEAD = [
  ...
  { id: 'e_description', label: 'e_description', alignRight: false },
  { id: 'm_description', label: 'm_description', alignRight: false },
...
export default function FeaturePage() {
    ...
    //* api url
    const getUrl = '/admin/feature/all';
    const deleteUrl = '/admin/feature/delete';
    ...
    const handleDelete = async () => {
        ...
        await axiosPrivate.post(deleteUrl, JSON.stringify(data))
    ...
    return (
        ...
        <Container>
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                ...
                <Link to="/dashboard/feature/create" component={RouterLink} state={{ from: location}} replace>
                ...
                <Scrollbar>
                    ...
                    <Table>
                        ...
                        {filteredNbMenus?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)?.map((row) => {
                            const { id, e_title, m_title, color, icon, e_description, m_description } = row;
                            return (
                            <TableRow hover key={id} tabIndex={-1} role="checkbox">
                                ...
                                <TableCell align="left">{e_description}</TableCell>
                                <TableCell align="left">{m_description}</TableCell>
        ...
        >
            <Link to={`/dashboard/feature/edit/${openId}`} component={RouterLink} sx={{ display: 'contents' }}>
            <MenuItem>
